...
class Nexo_Checkout extends CI_Model
{
	...
	**/
	...
	function create_permissions()
	{
		...
		$this->users->set_group( 'nexo_cashier' , __( 'Gérant de la caisse', 'nexo' ) , true );
		$this->users->set_group( 'shop_manager' , __( 'Gérant de la boutique', 'nexo' ) , true );
		$this->users->set_group( 'tester' , __( 'Privilège pour testeur', 'nexo' ) , true );
